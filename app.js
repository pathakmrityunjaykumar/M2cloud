...
const transporter = nodemailer.createTransport({
    service: 'gmail',
    auth: {
        user: 'pathakmrityunjaykumar@gmail.com', // Your email
        pass: 'zxqq gynh zpfg ucfd', // Your email password or App Password
    },
});
...
async function sendMobileOTP(mobile, mobileOTP) {
    ...
    const data = qs.stringify({
        ...
        senderid: 'M2CLOD',
        msgType: 'text',
        dltEntityId: '1701168605387539040',
        dltTemplateId: '1707169605956607399',
        duplicatecheck: 'true',
        output: 'json',
        sendMethod: 'quick',
    });
    ...
    const headers = {
        'apikey': 'ad805622799c5eac86d7d9a874b76a2c6e9f1ae9',
...
// API to approve user
const apiUrl = 'http://mars.x2ff.com:8082/api/users';
app.post('/v1/api/approve', async (req, res) => {
    ...
    try {
        ...
        await sendEmailApprove(user.email);
